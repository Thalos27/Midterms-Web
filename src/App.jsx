...
function App() {
  ...
  const registerGuitar = (e) => {
    ...
    if (stockQuantity === "") {
      ...
      valid = false;
    } else if (Number(stockQuantity) < 1 || Number(stockQuantity) > 100) {
  ...
  return (
    <div className="min-h-screen bg-[#e8f1f5] px-4 py-10 font-sans text-slate-800">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-2xl border border-[#d3e0e6] bg-[#e1ebf0] p-7 shadow-sm">
